...
| Task             |  Description |
:-------------------------:|:-------------------------:
<img src="tasks/example_tasks/videos/1.1.1.gif" width="400"/>  |  Understanding the instant effect of objects in an enviornment when an agent applys a single force.
