...
class GenerateLevels:
	...
	def get_horizontal_and_vertical_span(self, block_considered):
		...
		if '<class \'data_classes.Block\'>' == str(type(block_considered)):
		...
		elif '<class \'data_classes.Pig\'>' == str(type(block_considered)):
			vertical_span_of_the_block = abs(
		...
		elif '<class \'data_classes.Tnt\'>' == str(type(block_considered)):
			vertical_span_of_the_block = abs(
